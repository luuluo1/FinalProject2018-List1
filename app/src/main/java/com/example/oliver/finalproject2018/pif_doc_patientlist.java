...
public class pif_doc_patientlist extends AppCompatActivity {
    ...
    public class Doc_Pat_adapter extends CursorAdapter {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            String name = cursor.getString(cursor.getColumnIndex(PatientDatabaseHelper.COLUMN_DOC_NAME));

            TextView pat_ID = view.findViewById(R.id.Item_view_ID);
           final int id = cursor.getInt(cursor.getColumnIndex(PatientDatabaseHelper.COLUMN_DOC_PATIENT_ID));
